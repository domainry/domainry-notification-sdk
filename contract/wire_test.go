...
func TestNotificationIntentWireContractIsDeterministic(t *testing.T) {
	...
	encoded, err := json.Marshal(contract.NotificationIntent{
		...
		Surface: "business_workspace", RecipientUserIDs: []string{"user-1"}, SubjectType: "report", SubjectID: "report-1",
		SubjectVersion: "version-1", OccurredAt: "2026-08-28T00:00:00.000000000Z",
	})
	if err != nil {
		t.Fatal(err)
	}
	want := `{"id":"event-1","workspace_id":"workspace-1","source_event_id":"source-1","event_type":"report.completed","surface":"business_workspace","recipient_user_ids":["user-1"],"subject_type":"report","subject_id":"report-1","subject_version":"version-1","occurred_at":"2026-08-28T00:00:00.000000000Z"}`
